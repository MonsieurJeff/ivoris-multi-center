...
| Document | Purpose |
|----------|---------|
| [leadership-TEAM_STRUCTURE.md](leadership-TEAM_STRUCTURE.md) | Team roles, task assignment, 3-4 person team |
...
| Document | Purpose |
|----------|---------|
| [technical-CODING_EXERCISES.md](technical-CODING_EXERCISES.md) | Senior-level technical discussion prep |
| [technical-GLOSSARY.md](technical-GLOSSARY.md) | Terminology quick reference |
...
1. **[technical-CODING_EXERCISES.md](technical-CODING_EXERCISES.md)** - Algorithm trade-offs
2. **[leadership-TEAM_STRUCTURE.md](leadership-TEAM_STRUCTURE.md)** - How you'd build the team
3. **[leadership-AGENTIC_TEAM_MANAGEMENT.md](leadership-AGENTIC_TEAM_MANAGEMENT.md)** - Quality with AI

### For Business Stakeholders

1. **[business-DEMO_SCRIPT.md](business-DEMO_SCRIPT.md)** - Show the solution
2. **[business-COST_BENEFIT.md](business-COST_BENEFIT.md)** - Show the ROI
